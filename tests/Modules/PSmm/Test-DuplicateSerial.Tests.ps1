...
Describe 'Test-DuplicateSerial' {
    ...
    Context 'No Duplicates - Returns True' {
        ...
        It 'should return true when serials do not match master drives' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'MASTER001'
        ...
        It 'should return true when serials do not match backup drives' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'MASTER001'
            $backup = New-TestStorageDrive -Label 'Backup' -SerialNumber 'BACKUP001'
    ...
    Context 'Duplicates - NonInteractive Mode' {
        It 'should throw when duplicate found in NonInteractive mode' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'DUP001'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master
        ...
        It 'should throw for multiple duplicate serials' {
            ...
            $master1 = New-TestStorageDrive -Label 'Master1' -SerialNumber 'DUP001'
            $master2 = New-TestStorageDrive -Label 'Master2' -SerialNumber 'DUP002'
    ...
    Context 'ExcludeGroupId Parameter' {
        It 'should exclude specified group from duplicate check' {
            ...
            $master1 = New-TestStorageDrive -Label 'Master1' -SerialNumber 'SAME001'
            $master2 = New-TestStorageDrive -Label 'Master2' -SerialNumber 'SAME001'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master1
            Add-TestStorageGroup -Config $config -GroupId '2' -Master $master2
        ...
        It 'should allow re-using same serial when editing same group' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'SAME001'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master
    ...
    Context 'Duplicate Detection' {
        It 'should find duplicate in master drive' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'DUPLICATE'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master
        ...
        It 'should find duplicate in first backup drive' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'MASTER001'
            $backup = New-TestStorageDrive -Label 'Backup' -SerialNumber 'DUPLICATE'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master -Backup $backup
        ...
        It 'should find duplicates in multiple groups' {
            ...
            $master1 = New-TestStorageDrive -Label 'Master1' -SerialNumber 'DUP1'
            $master2 = New-TestStorageDrive -Label 'Master2' -SerialNumber 'DUP2'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master1
            Add-TestStorageGroup -Config $config -GroupId '2' -Master $master2
        ...
        It 'should ignore null/empty serials in check' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'REAL'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master
        ...
        It 'should handle serial with whitespace' {
            ...
            $master = New-TestStorageDrive -Label 'Master' -SerialNumber 'ABC123'
            Add-TestStorageGroup -Config $config -GroupId '1' -Master $master
