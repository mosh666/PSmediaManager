...
- **Versioning**: Added CI step to auto-run `Update-ModuleVersions.ps1` and an opt-in helper (`tools/Enable-GitHooks.ps1` → `.githooks/pre-commit.ps1`) so manifests stay in sync with Git versions locally.
